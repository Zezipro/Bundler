  ...
  return (
    <div className="flex-1 overflow-y-auto bg-transparent p-4 md:p-6 relative">
      ...
      <div className="mb-4 mx-auto max-w-4xl">
        <div className="glass-card p-4 relative overflow-hidden hover:border-blue-500/30 transition-all duration-300">
          ...
          <div className="flex items-center mb-3">
            ...
            <span className="text-sm font-mono tracking-wider text-slate-300 font-semibold">
              OPEN SOURCE PROJECT
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a 
              ...
              className="flex items-center justify-center py-2 px-4 rounded-lg bg-gradient-to-r 
                         from-blue-500 to-blue-600 text-white font-mono text-xs font-semibold
            ...
            <a 
              ...
              rel="noopener noreferrer"
              className="flex items-center justify-center py-2 px-4 rounded-lg bg-gradient-to-r 
                         from-blue-500/20 to-blue-500/10 border border-blue-500/30
                         hover:from-blue-500/30 hover:to-blue-500/20 
                         transition-all duration-300 transform hover:scale-105"
            >
              <svg 
                viewBox="0 0 24 24" 
              ...
              <span className="text-xs font-mono tracking-wider text-blue-400 font-semibold">
                @RAZEDOTBOT
              </span>
            </a>
          </div>
